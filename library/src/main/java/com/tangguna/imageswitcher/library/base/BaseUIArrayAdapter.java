...
public abstract class BaseUIArrayAdapter<T, H> extends BaseAdapter {
    ...
    public BaseUIArrayAdapter(Context context, int resource) {
        super();
    ...
    public BaseUIArrayAdapter(Context context, int resource, List<T> objects) {
        super();
