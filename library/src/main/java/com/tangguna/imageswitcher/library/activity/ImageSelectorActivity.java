package com.tangguna.imageswitcher.library.activity;
...
import com.tangguna.imageswitcher.library.adapter.FolderAdapter;
import com.tangguna.imageswitcher.library.adapter.ImageAdapter;
import com.tangguna.imageswitcher.library.callback.DataCallback;
import com.tangguna.imageswitcher.library.constant.Constants;
import com.tangguna.imageswitcher.library.entry.Folder;
import com.tangguna.imageswitcher.library.entry.Image;
import com.tangguna.imageswitcher.library.model.ImageModel;
import com.tangguna.imageswitcher.library.utils.DateUtils;
...
//            Toast.makeText(this, "没有图片", Toast.LENGTH_LONG).show();
    ...
    private void loadImageForSDCard() {
        ImageModel.loadImageForSDCard(this, new DataCallback() {
            @Override
